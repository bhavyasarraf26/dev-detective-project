...
window.matchMedia checks if my browser supports window.matchMedia API or not.
If it support then we will pass "(prefers-color-scheme: dark)" as parameter to the above API and use matches property of it.
...
*/
  ...
  //by default, bhavya-sarraf-26 ki info show krre h UI pr
  getUserData(url + "bhavyasarraf26");
}
